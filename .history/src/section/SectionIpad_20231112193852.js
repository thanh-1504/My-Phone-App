...
const SectionIpad = () => {
  ...
  console.log(dataMainPage[0].dataMainPage[1].sectionIpad);
  useEffect(() => {
    dispatch(handleGetDataIpad(dataMainPage[0].dataMainPage[1].sectionIpad));
  }, [dispatch]);
  console.log(dataIpad);
  return (
        ...
        {width === 414 ? (
          ...
          >
            {dataIpad.map((dataItem) => (
              ...
              >
                <ProductsItem data={data} srcImg="https://www.bihouse.vn/img_data/images/132657839873-iPad-Pro-M2-129-5G-grey-thumb-650x650-1.png"></ProductsItem>
              </SwiperSlide>
            ))}
          </Swiper>
        )}
