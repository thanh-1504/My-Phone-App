...
const FilterProduct = ({ slug = "", data, total = 0 }) => {
  ...
  switch (slug) {
    ...
    case "iPad": {
      style =
        "text-sm font-medium text-white mb:py-[7px] mb:px-[30px] mb:mr-4 mb:mb-3 mb:tracking-[2px] cursor-pointer transition-all h-[35px] mb:mt-5";
      break;
    }
    case "Mac": {
      style =
  ...
  return (
    <div className="filter-wrap ">
      <div className=" mb:flex mb:whitespace-nowrap mb:overflow-x-auto lg:pl-[46px] lg:mt-10 items-center">
        <span className="text-white font-bold mb-3 lg:mr-4 mb:mt-4">
          Tất cả ({total})
        </span>
