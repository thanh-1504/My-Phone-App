...
const test = [
  ...
  { name: "iPad Air", brand: "iPad",path: "filter/iPad" },
  { name: "iPad Pro", brand: "iPad",path: "filter/iPad" },
  { name: "iPad Mini", brand: "iPad",path: "filter/iPad" },
  { name: "iPad Pro M1", brand: "iPad",path: "filter/iPad" },
];
