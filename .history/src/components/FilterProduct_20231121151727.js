...
const test = [
  ...
  { name: "iPhone 14", brand: "iPhone",path:"filter/iPhone15" },
  { name: "iPhone 13", brand: "iPhone",path:"filter/iPhone15" },
  { name: "iPhone 12", brand: "iPhone",path:"filter/iPhone15" },
  { name: "iPhone 11", brand: "iPhone",path:"filter/iPhone15" },
