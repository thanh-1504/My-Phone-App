...
const ProductsItem = ({ style = "", data, ...props }) => {
  ...
  return (
    ...
    >
      <div className="absolute bg-[#3b1213] lg:h-[30px] lg:-top-7 lg:w-full lg:right-0 lg:rounded-t-2xl uppercase text-white font-medium flex items-center justify-center"><span>Mở rộng đổi + 2 năm</span></div>
      <div className={``}>
