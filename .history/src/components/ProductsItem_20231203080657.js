...
const ProductsItem = ({ style = "", data, ...props }) => {
  ...
  return (
    ...
    >
      <div className="absolute bg-red-500 lg:h-[30px] lg:-top-7 lg:w-full lg:right-0 lg:rounded-t-2xl uppercase text-white font-medium flex item">Mở rộng đổi + 2 năm</div>
      <div className={``}>
