...
const ProductsItem = ({ style = "", data, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <div className={`bg-[#191717] mb:h-[300px] rounded-b-lg relative lg:w-full lg:h-[360px] cursor-pointer lg:px-5 mb:px-2 mb:pb-2 mb:mr-2 mr-10 md:w-full md:h-[400px] sm:w-[334px] sm:h-[440px] ${style} mb:w-full`}>
