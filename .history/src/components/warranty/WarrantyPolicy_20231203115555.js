...
import ItemWarrancy from "../ItemWarrancy";
// mb:grid mb:grid-cols-2 mb:gap-y-6 lg:flex lg:mt-10 bg-[#0f0f0f] lg:justify-evenly mb:mt-4 select-none
const WarrantyPolicy = () => {
  return (
    <div className="sm:flex sm:items-center bg-[#0f0f0f] sm:justify-evenly mb:grid mb:grid-cols-2 mb:gap-y-6">
      <ItemWarrancy
