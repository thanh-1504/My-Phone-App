...
import { fecthDataProvince } from "../../reux-thunk/Slice/request";
  ...
  return (
    <div className="px-8 py-6 pt-6 mt-3 bg-white rounded-lg">
      ...
      <div className="flex flex-col w-[395px] mt-5">
        ...
        <div>
        <select name="" id="select__address" className="w-[786px] input--payment placeholder:text-sm placeholder:text-[#dfe0e3] mt-2 focus:border-b-[#80bdff] ease-linear duration-75 cursor-pointer">
