        ...
        <div className="mt-3">
          <div>
            ...
            <input
              ...
              name="input__buy"
              id="buyer__name"
              className="w-[340px] input--payment placeholder:text-sm placeholder:text-[#dfe0e3] mt-2 focus:border-b-[#80bdff] ease-linear duration-75 mb-2"
          ...
          <div className="">
            ...
            <input
              ...
              type="text"
              className="w-[340px] input--payment placeholder:text-sm placeholder:text-[#dfe0e3] mt-2 focus:border-b-[#80bdff]"
