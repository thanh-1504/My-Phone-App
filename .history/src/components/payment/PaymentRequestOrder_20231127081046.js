      ...
      <div className="flex flex-col w-[395px] mt-5">
        ...
        <div className="">
          ...
          <div className="max-w-[780px] border border-[#ced4da] w-[780px]">
            <span className="w-full p-1 h-[38px] block">
              <input type="search" className="w-full outline-none border border-[#ced4da] rounded-md py-1"/>
            </span>
            <ul className="list-country list-none max-h-[15em] overflow-y-auto">
              <li className="cursor-pointer py-[5px] hover:bg-blue-500 hover:text-white pl-2">Tp Ho Chi Minh</li>
