...
const PaymentInfoProductOnMb = () => {
  ...
  let price = +dataPayment?.price?.replaceAll(".", "")?.replace("đ", "");
    ...
    <div className="bg-white rounded-t-lg">
      <div className="relative flex items-center">
        <img
          ...
          alt="imgProduct"
        />
        <span className="font-semibold max-w-[136px] text-justify">
          {dataOption[0]?.name}
        </span>
        <div>
          <div className="flex mt-8 mb-1 absolute right-5 top-[6px]">
          ...
          <span className="text-[#98a4b1] font-medium text-base absolute right-4 top-[64px]">
