  ...
  return (
    <div className="relative bg-white rounded-t-lg">
      <div className="flex items-center lg:p-[8px]">
        ...
        <span>
          <div className="flex items-center absolute right-[80px] bottom-[70px]">
          ...
          <span className="absolute right-[80px] mt-1 text-[#98a4b1] font-medium text-base select-none bottom-[40px]">
