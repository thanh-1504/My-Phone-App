  ...
  return (
    <div className="px-8 py-6 pt-6 mt-3 bg-white rounded-lg">
      ...
      <div>
        ...
        <div className="mt-3">
          <div className="flex">
            <label htmlFor="buyer__name" className="text-sm font-medium block">
              Họ và tên
            </label>
            <input
              type="text"
              name="input__buy"
              id="buyer__name"
              className="w-[385px] input--payment placeholder:text-sm placeholder:text-[#dfe0e3] mt-2 focus:border-b-[#80bdff] ease-linear duration-75 mb-3"
