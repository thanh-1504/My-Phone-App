  ...
  return (
    <div className="relative bg-white rounded-t-lg">
      <div className="flex items-center lg:p-[8px]">
        ...
        <span>
          <div className="flex items-center absolute right-[80px] bottom-[75px]">
          ...
          <span className="absolute right-[80px] mt-1 text-[#98a4b1] font-medium text-base select-none bottom-[46px]">
            {formattedProductPrice}
          </span>
        </span>
      </div>
      <div className="w-full h-10 bg-[#f9f9f9]">
        <div className="leading-[2.5rem] float-right mr-[84px]">
