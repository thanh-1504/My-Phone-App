...
import { handleIncrease } from "../../reux-thunk/Slice/paymentSlice";
      ...
      <div className="flex items-center">
        ...
        <div>
          <div className="ml-[400px] flex">
            ...
            <span className="h-5 px-[0.314rem] ml-2 border rounded border-[rgba(34, 49, 63, 0.1)] select-none relative leading-4 mr-2 "></span>
            <div className="cursor-pointer bg-[#f4f5f5] w-5 h-5 relative rounded">
              <FontAwesomeIcon
                icon={faPlus}
                // onClick={() => dispatch(handleIncrease())}
                className="w-[40px] h-2 absolute top-[0.35rem] right-[-0.7rem] translate-x-[-3%] translate-y-[1px] "
              />
            </div>
          </div>
