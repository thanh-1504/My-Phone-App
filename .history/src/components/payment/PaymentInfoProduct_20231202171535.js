  ...
  return (
    <div className="bg-white rounded-t-lg">
      <div className="flex items-center lg:p-[8px]">
        ...
        <span>
          <div className="flex items-center relative left-[60px]">
          ...
          <span className="absolute right-[110px] mt-1 text-[#98a4b1] font-medium text-base select-none">
            {formattedProductPrice}
          </span>
        </span>
      </div>
      <div className="w-full h-10 bg-[#f9f9f9]">
        <div className="leading-[2.5rem] float-right mr-[108px]">
