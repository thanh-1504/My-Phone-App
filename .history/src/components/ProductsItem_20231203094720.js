...
const ProductsItem = ({ style = "", data, ...props }) => {
  ...
  return (
    <div
    className="lg:w-[252px] md:w-[340px]"
    >
      <div className=" bg-[#3b1213] lg:h-[30px]  rounded-t-2xl flex items-center justify-center  sm:w-[334px] mb:w-[189.6px]">
        <span className="text-sm font-medium text-white uppercase">
          Mở rộng đổi + 2 năm
        </span>
      </div>
      <div className={`bg-[#191717] mb:h-[300px] rounded-b-lg relative lg:w-[252px] w-full lg:h-[360px] cursor-pointer lg:px-5 mb:px-2 mb:pb-2 mb:mr-2 mr-10 md:w-[340px] md:h-[400px] sm:w-[334px] sm:h-[440px] ${style}`}>
