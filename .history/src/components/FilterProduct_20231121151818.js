...
const test = [
  ...
  { name: "iPad ", brand: "iPad",path: "filter/iP" },
  { name: "iPad Air", brand: "iPad",path: "filter/iP" },
  { name: "iPad Pro", brand: "iPad",path: "filter/iP" },
  { name: "iPad Mini", brand: "iPad",path: "filter/iP" },
  { name: "iPad Pro M1", brand: "iPad",path: "filter/iP" },
];
