...
const ProductsItem = ({ style = "", data, ...props }) => {
  ...
  return (
    ...
    >
      <div className="absolute bg-[#3b1213] lg:h-[30px] lg:-top-7 lg:w-full lg:right-0 lg:rounded-t-2xl flex items-center justify-center">
      ...
      <>
        ...
        >
          <h3
            className={`text-[16px] font-semibold name__product--hover lg:max-w-[252px] lg:!h-[45px] uppercase
            }`}
          >
            {name}
          </h3>
