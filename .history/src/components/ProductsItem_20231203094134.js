...
const ProductsItem = ({ style = "", data, ...props }) => {
  ...
  return (
    <div>
      ...
      <div
        className={`bg-[#191717] mb:h-[300px] rounded-b-lg relative w-full lg:h-[360px] cursor-pointer lg:px-5 mb:px-2 mb:pb-2 mb:mr-2 mr-10 md:h-[400px] sm:h-[440px] ${style} lg:mr-10`}
      >
