...
const ProductsItem = ({ style = "", data, ...props }) => {
  ...
  return (
    <div
      className={``}
    >
      <div className=" bg-[#3b1213] !bg-red-500 lg:h-[30px] lg:-top-7 lg:w-full lg:right-0 lg:rounded-t-2xl flex items-center justify-center md:w-full">
        <span className="text-sm font-medium text-white uppercase">
          Mở rộng đổi + 2 năm
        </span>
      </div>
      <div className={`bg-[#191717] mb:h-[300px] rounded-b-lg relative mt-10 lg:w-[252px] lg:h-[360px] cursor-pointer lg:px-5 mb:px-2 mb:pb-2 mb:mr-2 mr-10 md:w-[340px] md:h-[400px] sm:w-[334px] sm:h-[480px] ${style}`}>
