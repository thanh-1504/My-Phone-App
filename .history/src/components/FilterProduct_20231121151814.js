...
const test = [
  ...
  { name: "iPad ", brand: "iPad",path: "filter/" },
  { name: "iPad Air", brand: "iPad",path: "filter/" },
  { name: "iPad Pro", brand: "iPad",path: "filter/" },
  { name: "iPad Mini", brand: "iPad",path: "filter/" },
  { name: "iPad Pro M1", brand: "iPad",path: "filter/" },
];
