...
const ProductsItem = ({ style = "", data, ...props }) => {
  ...
  return (
    <div
      className={`bg-[#191717] mb:h-[300px] mt-10 rounded-xl lg:w-[252px] lg:h-[360px] ${style} cursor-pointer lg:px-5 mb:px-2 mb:pb-2 mb:mr-2 mr-10 md:w-[340px] md:h-[400px] md:pr-4`}
    >
