    ...
    <div className="">
      ...
      <div
        className={`lg:mt-6 lg:mb-6 ${
          ...
          // 'flex items-center flex-wrap justify-stretch'
          ""
        }`}
      >
        {data[0]?.optionProduct &&
          data[0]?.optionProduct.map((item, index) => (
            <>
              ...
              <label
                ...
                className={`bg-[#2f3033] mb:p-2 lg:px-3 lg:inline-block lg:max-w-[205px] rounded-md cursor-pointer border product--checked${
                  index + 1
