...
const OptionProduct = ({ pushRef, name = "", price = "" }) => {
  return (
    ...
    <div className="">
      ...
      <div>
        <input name="capicity" id="256GB" type="radio" className=" radio" />
        <label
          htmlFor="256GB"
          className={`bg-[#2f3033] mb:p-2 rounded-md cursor-pointer border product--checked1 }`}
        >
          <span className="text-white">256 GB</span>
        </label>
        <input name="capicity" id="512GB" type="radio" className=" radio" />
        <label
          htmlFor="512GB"
          className={`bg-[#2f3033] mb:p-2 rounded-md cursor-pointer border product--checked2 }`}
        >
          <span className="text-white">512 GB</span>
        </label>
        <input name="capicity" id="1TB" type="radio" className=" radio" />
        <label
          htmlFor="1TB"
          className={`bg-[#2f3033] mb:p-2 rounded-md cursor-pointer border product--checked }`}
        >
