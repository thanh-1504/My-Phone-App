...
const OptionProduct = ({ pushRef, name = "", price = "" }) => {
  return (
    ...
    <div className="">
      ...
      <div>
        <input name="capicity" id="256GB" type="radio" className=" radio1" />
        <label
          htmlFor="256GB"
        ...
        <input name="capicity" id="512GB" type="radio" className=" radio2" />
        <label
          htmlFor="512GB"
        ...
        <input name="capicity" id="1TB" type="radio" className=" radio3" />
        <label
          htmlFor="1TB"
