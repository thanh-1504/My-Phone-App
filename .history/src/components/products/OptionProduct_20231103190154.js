...
const OptionProduct = ({ style = "" }) => {
  ...
  return (
    <div
      onClick={() => setChangeBorderColor(true)}
      className={`mb:w-[381px] mb:h-[84px] border ${changeBorderColore ? 'border-white' : "border"} rounded-xl flex items-center justify-between px-5 mb:mt-5`}
    >
