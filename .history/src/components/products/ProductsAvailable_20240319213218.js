...
const ProductsAvailable = () => {
  return (
    <div className="mb:grid mb:grid-cols-3 mb:gap-y-6 lg:flex lg:mt-[80px] lg:justify-center bg-[#0f0f0f] mb:mt-[60px] cursor-pointer mb:mb-10 lg:mb-[60px] lg:gap-x-[55px]">
      <div>
        <ItemProduct
