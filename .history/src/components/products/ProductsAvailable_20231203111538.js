...
const ProductsAvailable = () => {
  return (
    <div className="mb:grid mb:grid-cols-3 mb:gap-y-6 lg:flex lg:mt-[80px] lg:justify-end bg-[#0f0f0f] mb:mt-[60px] cursor-pointer mb:mb-10 lg:mb-[60px] lg:pl-[100px] items-center">
      <div>
        <ItemProduct
          srcImg="https://www.bihouse.vn/img_data/images/054672409108-1.png"
          title="iPhone"
          imgClassName="mb:w-[108px] mb:h-[69px] mb:relative mb:left-[0.5rem] lg:left-[-0.1rem] lg:h-[105px] lg:w-[158px] "
      ...
      <div className="lg:mr-[110px] lg:ml-[55px]">
        <ItemProduct
