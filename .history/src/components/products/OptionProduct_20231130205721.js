  ...
  return (
    <div className="">
      ...
      {data[0]?.optionProduct && (
        <span className="text-white mb:mb-8 lg:mb-0 block">Phiên bản</span>
      )}
      <div
        className={`lg:mt-6 lg:mb-6 ${
          data[0]?.optionProduct.length > 3 && "lg:flex lg:flex-wrap"
        }`}
      >
        {data[0]?.optionProduct &&
          data[0]?.optionProduct.map((item, index) => (
            <>
              ...
              <label
                ...
                className={`bg-[#2f3033] mb:p-2 lg:my-2 lg:px-3 rounded-md cursor-pointer border product--checked${
                  index + 1
      ...
      {data[0]?.optionProduct && (
        <p className="text-white mb:mb-4 mb:mt-8 lg:mt-0">Màu sắc</p>
      )}
      <div>
        {data[0]?.color &&
            ...
            <>
              ...
              <label
                ...
                className={`w-10 h-10 rounded-full inline-block border-[3px] product-color--checked${
                  index + 1
                } lg:mr-4 mb:mr-4 cursor-pointer`}
              ></label>
            </>
          ))}
      </div>
