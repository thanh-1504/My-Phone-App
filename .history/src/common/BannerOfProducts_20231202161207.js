  ...
  return (
    <div className="mb:pt-[62px] lg:pt-0 ">
      ...
      <section className="list-image">
        ...
        >
          {dataImg.map((slide) => (
            <SwiperSlide className="mb:!w-[104px] lg:!w-[89px] md:!w-[110px] md:mr-3">
              <ImageItem
                srcImg={slide}
                style="mb:w-[54px] mb:h-[54px] rounded-lg lg:w-[79px] lg:h-[79px] lg:ml-2 bg-white lg:p-[5px] md:h-[110px] sm:w-[104px] sm:h-[104px]"
              ></ImageItem>
            </SwiperSlide>
          ))}
        </Swiper>
