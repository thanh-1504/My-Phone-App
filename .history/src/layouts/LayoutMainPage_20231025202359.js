      ...
      <div className="w-full mb:px-4 mb:py-5 lg:px-[10px] ">
        <div className="mb:grid mb:grid-cols-2 mb:gap-y-6 lg:flex lg:mt-10 bg-[#0f0f0f] lg:justify-evenly">
          ...
          <ItemProduct
            ...
            imgClassName="mb:w-[113px] mb:relative mb:left-8 lg:left-12 lg:h-[67px] lg:w-[66px]"
            titleClassName="mb:mt-1 mb:h-[34px] text-xs font-semibold mb:text-center lg:mt-4"
          ></ItemProduct>
        </div>
      </div>
    </div>
