    ...
    <LayoutPage>
      ...
      <div className="px-[15px]">
        {widthScreen >= 1280 && (
          <div>
            <div
              className={`flex w-full lg:pt-[80px] ${
                widthScreen >= 1280
            ...
            >
              ...
              >
                ...
                <SpecificationTable
                  style={` ${widthScreen >= 1280 && "lg:ml-10 lg:w-[530px]"}`}
              ...
              >
                ...
                <div className={`${widthScreen >= 1280 && "lg:mt-10"} `}>
                  ...
                  <Border style={`${widthScreen >= 1280 ? 'mb:mt-4 mb:pt-5 lg:w-[380px] lg:mt-[50px] ' : 'mb:mt-10 mb:mb-4'}`}></Border>
