...
const PaymentPage = ({ data }) => {
  ...
  const handleSubmitFormPayment = (values) => {
    console.log(values);
    dispatch(handleSetInfoBuyer({nameBuyer: values.name,phoneBuyer: values.phoneNumber}))
  };
  if (isSubmitSuccessful) {
    Swal.fire({
      ...
      <div>
        <p class="info_buyer">Họ tên: Dương Nhật Thành</p>
        <p class="info_buyer">Số điện thoại: 0562407343</p>
        <p class="info_buyer">Địa chỉ: 131/3 minh phụng p9 q6</p>
      </div>
