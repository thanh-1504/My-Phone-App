...
import { handleGetDataById } from "../reux-thunk/Slice/handler";
const test = [{}, {}, {}, {}, {}];
const ProductDetailPage = () => {
  ...
  const dataProduct = data.filter((item) => item.id.toString() === slug);
            ...
            <div className="flex w-full lg:pt-[120px]">
              ...
              <div className={`w-[${widthScreen / 2}px] mt-[40px] `}>
                ...
                <div className="lg:ml-[120px] lg:mt-10">
                  <OptionProduct name={dataProduct[0]?.name} price={dataProduct[0]?.price} pushRef={pushRef}></OptionProduct>
                  <OptionProduct name={dataProduct[0]?.name} price={dataProduct[0]?.name} pushRef={pushRef}></OptionProduct>
                  <OptionProduct name={dataProduct[0]?.name} price={dataProduct[0]?.name} pushRef={pushRef}></OptionProduct>
