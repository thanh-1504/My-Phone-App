          ...
          <div className="bg-white rounded-t-lg">
            <div className="flex items-center">
              ...
              <div>
                ...
                <span className="absolute right-[320px]  text-[#98a4b1] font-medium text-base top-[125px]">
                  27.990.000 đ
                </span>
              </div>
            </div>
            <div className="w-full h-10 bg-[#f9f9f9]">
              <div className="leading-[2.5rem] float-right mr-[118px]">
                ...
                <span className="ml-6 text-base font-semibold text-red-500">
                  27.990.000 đ
                </span>
              </div>
            </div>
          ...
          <div className="px-8 py-6 pt-6 pb-8 mt-3 bg-white rounded-lg">
            ...
            <div className="flex flex-col w-[395px] mt-5">
              ...
              <input
                ...
                name="input_address"
                id="input__address"
                className="w-[786px] input--payment placeholder:text-sm placeholder:text-[#dfe0e3] mt-2 focus:border-b-[#80bdff] ease-linear duration-200"
                placeholder="Dương Nhật Thành"
              />
            </div>
            <div className="flex flex-col w-[395px] mt-5">
