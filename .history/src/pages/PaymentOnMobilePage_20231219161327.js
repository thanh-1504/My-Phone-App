          ...
          <div className="py-6 pt-6 pl-8 pr-2 mt-3 bg-white rounded-lg">
            ...
            <div className="flex flex-col w-full mt-5">
              ...
              <div>
                ...
                <div className="w-full h-[0.5px] bg-[#ced4da]"></div>
                {showProvince && (
                  <div className="max-w-[780px] border border-[#ced4da] relative top-[-10px] mt-5">
              ...
              <div className="flex items-center">
                <div
                  ...
                  className="items-center cursor-pointer lex "
                >
                  <span
                    className={`text-sm ${
                      labelDistrict
              ...
              <input
                ...
                name="address"
                id="input__address"
                className="input--payment placeholder:text-sm placeholder:text-[#dfe0e3] mt-2 focus:border-b-[#80bdff] ease-linear duration-75 mb-4"
              ...
              <input
                ...
                name="input__note"
                id="input__note"
                className="w-full input--payment placeholder:text-sm placeholder:text-[#dfe0e3] mt-2 focus:border-b-[#80bdff] ease-linear duration-75"
