                    ...
                    <div className="flex justify-between">
                      <div className="w-[395px]">
                        ...
                        <input
                          ...
                          {...register("name")}
                          id="buyer__name"
                          className={`w-full input--payment placeholder:text-sm placeholder:text-[#dfe0e3] mt-2 focus:border-b-[#80bdff] ease-linear duration-75 mb-3 ${errors?.name?.message && 'border-b-[#80bdff]'}`}
