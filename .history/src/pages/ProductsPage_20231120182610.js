...
const ProductsPage = () => {
  ...
  // const { dataMainPage: dataairpodProduct } = dataAirpod;
  if (!dataiPhoneProduct || !dataiPadProduct || datamacProduct) return;
  ...
  // const dataAirpodProduct = dataairpodProduct[3].sectionAirpod;
