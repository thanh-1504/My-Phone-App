...
const ProductsPage = () => {
  ...
  return (
    <LayoutPage>
      ...
      <div className="mb:px-[15px] lg:px-5 lg:mt-10">
        <div className="mb-8">
          <FilterProduct
            slug={typeProduct}
          ...
          ></FilterProduct>
          <div className="mb:grid mb:grid-cols-2 mb:gap-x-2 lg:max-w-[1200px] lg:grid-cols-4 gap-x-0 lg:pl-[45px] lg:gap-y-3 lg:pb-10 sm:px-8 lg:px-0">
