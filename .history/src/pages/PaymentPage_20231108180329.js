            ...
            <div className="px-4 py-3 bg-[#ebf4f8]">
              ...
              <div className="px-8 pt-6 mt-3 bg-white rounded-lg">
                ...
                <div className="flex items-center mt-5">
                  <label htmlFor="sex" className="mr-2 leading-10 select-none ">
                    <input type="radio" name="sex" />
                    <span className="ml-1 text-sm font-medium">Anh</span>
                  </label>
                  <label htmlFor="sex" className="select-none ">
                    <input type="radio" name="sex" />
                    <span className="ml-1 text-sm font-medium">Chị</span>
                  </label>
                </div>
              </div>
            </div>
