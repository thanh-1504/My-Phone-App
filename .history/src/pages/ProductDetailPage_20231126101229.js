...
import { handleBuyProduct } from "../reux-thunk/Slice/optionProductSlice";
const test = [{}, {}, {}, {}, {}];
const ProductDetailPage = () => {
  ...
  const { dataOption, isBuy } = useSelector((state) => state.option);
          ...
          <div>
            <div className="flex w-full lg:pt-[120px]">
              <div className={`w-[${widthScreen / 2}px]`}>
                ...
                <div>
                  {isBuy && <PaymentPage data={dataOption}></PaymentPage>}
                </div>
              ...
              <div className={`w-[${widthScreen / 2}px] mt-[40px] lg:p-[50px]`}>
                ...
                <div className="lg:mt-10">
                  ...
                  <div className="text-center translate-x-[-10px]">
                    <Button
                      onClick={() => dispatch(handleBuyProduct())}
