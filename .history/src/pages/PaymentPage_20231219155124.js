  ...
  useEffect(() => {
    ...
    confirmBtn &&
      confirmBtn.addEventListener("click", () => {
        dispatch(handleBuyProduct(false));
      });
  });
  ...
  return (
    <div>
      <div className={`z-50 modal bg-black/40`}>
        <div className="overflow-x-hidden sm:w-[536px] sm:h-[820px] lg:w-[895px] lg:h-[450px] overflow-y-auto modal-content rounded-lg">
                ...
                <div>
                  ...
                  <div className="mt-3">
                    <div className="flex justify-between">
                      <div className="w-[395px] sm:mr-3 lg:mr-0">
                        <label
                          htmlFor="buyer__name"
                        ...
                        <input
                          ...
                          {...register("name")}
                          id="buyer__name"
                          className={`w-auto input--payment placeholder:text-sm placeholder:text-[#dfe0e3] mt-2 focus:border-b-[#80bdff] ease-linear duration-75 mb-3 ${
                    ...
                    <div className="">
                      ...
                      <input
                        ...
                        type="text"
                        {...register("email")}
                        className="sm:w-[440px] lg:w-[800px] input--payment placeholder:text-sm placeholder:text-[#dfe0e3] focus:border-b-[#80bdff]"
                ...
                <div className="px-8 py-6 pt-6 mt-3 bg-white rounded-lg">
                  ...
                  <div className="flex flex-col w-[395px] mt-5">
                    ...
                    <div>
                      <div
                        ...
                        className="sm:w-[440px] lg:w-[786px] cursor-pointer flex items-center"
                      >
                        <span
                          className={`text-sm ${
                            labelProvince
                      ...
                      <div className="lg:w-[786px] sm:w-[440px] h-[0.5px] bg-[#ced4da]"></div>
                      {showProvince && (
                        <div className="lg:w-[780px] sm:w-[440px] border border-[#ced4da] w-[786px] relative top-[-10px] mt-5">
                    ...
                    <div>
                      <div
                        ...
                        className="lg:w-[786px] sm:w-[440px] cursor-pointer flex items-center"
                      >
                        <span
                          className={`text-sm ${
                            labelDistrict
                      ...
                      <div className="lg:w-[786px] sm:w-[440px] h-[0.5px] bg-[#ced4da]"></div>
                      {showDistrict && (
                        <div className="lg:w-[786px] sm:w-[440px] border border-[#ced4da] w-[786px] relative top-[-10px] mt-5">
                          <ul className="list-country list-none max-h-[10em] overflow-y-auto w-[786px]">
                  ...
                  <div className="flex flex-col w-[395px] mt-5">
                    ...
                    <input
                      ...
                      name="address"
                      id="input__address"
                      className="lg:w-[786px] sm:w-[440px] input--payment placeholder:text-sm placeholder:text-[#dfe0e3] mt-2 focus:border-b-[#80bdff] ease-linear duration-75 mb-4"
                    ...
                    <input
                      ...
                      name="input__note"
                      id="input__note"
                      className="lg:w-[786px] sm:w-[440px] input--payment placeholder:text-sm placeholder:text-[#dfe0e3] mt-2 focus:border-b-[#80bdff] ease-linear duration-75"
