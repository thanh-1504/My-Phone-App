    ...
    <LayoutPage>
      ...
      <div className="mb:px-[15px] lg:px-5 sm:px-10">
        <div className="mb-8 ">
          ...
          ></FilterProduct>
          <div className="mb:grid mb:grid-cols-2 lg:grid-cols-4 gap-x-0 lg:gap-y-0 lg:pb-10 lg:px-0 lg:mt-10 md:gap-y-10 md:mt-8 sm:gap-y-7 sm:gap-x-10 mb:gap-y-8 mb:gap-x-3 mb:mt-10 lg:place-items-center lg:gap-x-0">
