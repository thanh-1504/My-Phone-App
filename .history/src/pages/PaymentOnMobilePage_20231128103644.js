...
import { handleFetchProvince, handleFetchWard, handlerFetchDistrict } from "../reux-thunk/Slice/handler";
import { handleShowDistricts, handleShowProvinces, handleShowWards } from "../reux-thunk/Slice/paymentSlice";
                  ...
                  <div className="flex flex-col w-[395px] mt-5">
                    ...
                    <div>
                      ...
                      >
                        <span
                          className={`text-sm ${
                            labelProvince ? "text-black font-semibold" : "text-[#e3e0de]"
                          } mb-1`}
                        >
                          {labelProvince
                            ? labelProvince
                    ...
                    <div>
                      ...
                      >
                        <span
                          className={`text-sm ${
                            labelDistrict ? "text-black font-semibold" : "text-[#e3e0de]"
                          } mb-1`}
                        >
