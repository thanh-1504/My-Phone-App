...
const PaymentOnMobilePage = () => {
  ...
  const { isBuyProduct, dataProvince, dataDistrict, dataWards, infoBuyer } =
              ...
              <div className="mt-3">
                <div>
                  ...
                  <input
                    ...
                    name="name"
                    id="buyer__name"
                    className={`w-[340px] input--payment placeholder:text-sm placeholder:text-[#dfe0e3] mt-2 focus:border-b-[#80bdff] ease-linear duration-75 mb-3 ${ errors?.name?.message && "focus:border-b-red-500"}`}
