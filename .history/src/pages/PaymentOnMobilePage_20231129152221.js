              ...
              <div className="mt-3">
                ...
                <div className="">
                  ...
                  <input
                    ...
                    name="phoneNumber"
                    type="text"
                    className={`w-[340px] input--payment placeholder:text-sm placeholder:text-[#dfe0e3] mt-2 focus:border-b-[#80bdff] mb-3 ${errors?.phoneNumber?.message && "focus:border-b-red-500"}`}
