...
const ProductDetailPage = () => {
  const a = document.querySelectorAll(".option__type");
  a.forEach((item) =>
    item.addEventListener("click", (e) => {
      a.forEach((e) => e.currentTarger.classList.remove("option__type--active"));
      e.target.classList.add("option__type--active");
    })
  );
  return (
    <LayoutPage>
