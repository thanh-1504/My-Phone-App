      ...
      <div className="mb:px-[15px] lg:px-5">
        <div className="mb-8">
          <FilterProduct
            ...
            total={data.length || 0}
          ></FilterProduct>
          <div className="mb:grid mb:grid-cols-2 lg:max-w-[1200px] lg:grid-cols-4 !gap-x-8 lg:gap-y-3 lg:pb-10 mt-10 md:gap-y-10 sm:gap-y-10 mb:gap-y-8 lg:pl-[38px] md:pl-[22px] sm:pl-[15px] mb:!gap-x-0 ">
            {data.map((dataItem) => (
