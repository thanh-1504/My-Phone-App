                ...
                <div>
                  ...
                  <div className="flex items-center mt-3">
                    <div className="flex flex-col w-[395px]">
                      <label htmlFor="buyer__name">Họ và tên</label>
                      <input
                        type="text"
                        name="input__buy"
                        id="buyer__name"
                        className="w-[385px] input--payment placeholder:text-sm placeholder:text-[#dfe0e3] mt-5"
                    ...
                    <div className="flex flex-col w-[395px]">
                      ...
                      <input
                        ...
                        type="text"
                        className="w-[385px] input--payment placeholder:text-sm placeholder:text-[#dfe0e3]"
