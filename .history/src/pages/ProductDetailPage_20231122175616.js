...
const ProductDetailPage = () => {
  ...
  //       optionRef.current
  //         .slice(0, 4)
  //         .forEach((e) => e.classList.remove("option__type--active"));
          ...
          <div>
            <div className="flex w-full lg:pt-[120px]">
              <div className={`w-[${widthScreen / 2}px]`}>
                ...
                <Border style="lg:w-[530px] lg:ml-[45px] lg:mt-4 lg:mb-4 w-3"></Border>
                <SpecificationText></SpecificationText>
                <SpecificationTable
                  style="lg:ml-10 lg:w-[530px]"
                  data={dataProduct[0]?.TechnicalSpecifications}
                ></SpecificationTable>
              </div>
