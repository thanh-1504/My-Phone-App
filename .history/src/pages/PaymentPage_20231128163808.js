          ...
          >
            <LayoutPayment>
                    ...
                    <div className="flex justify-between">
                      <div className="w-[395px]">
                        ...
                        <input
                          ...
                          {...register("name")}
                          id="buyer__name"
                          className={`w-full input--payment placeholder:text-sm placeholder:text-[#dfe0e3] mt-2 focus:border-b-[#80bdff] ease-linear duration-75 mb-3 ${errors?.name?.message && 'focus:border-b-red-500'}`}
              ...
              <div className="pt-6 pb-12 text-center">
                <button
                  type="submit"
                  onClick={handleSubmitFormPayment}
