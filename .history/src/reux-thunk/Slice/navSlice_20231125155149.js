...
import { handleGetAllDataNav, handleGetDataBySlug, handleShowBrandName } from "./handler";

const navSlice = createSlice({
  name: "nav",
  initialState: { data: [], nameBrand: "", imgSrcBanner: "", allData: [],brandName: },
  reducers: {
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(handleShowBrandName.fulfilled, (state, action) => {
        state.allData = action.payload;
      });
